function appendClass() {
    ...
    document.getElementById("toto").classList.toggle('open');
    document.getElementById("menu").classList.toggle('active');
    document.getElementById("back-menu").classList.toggle('focus');
    //document.getElementById('back-menu').focus();
}


// function UpMobileBack (){
//
//   document.getElementById("toto").classList.toggle('open');
//   document.getElementById("back-menu").classList.toggle('active');
//
//
// }
